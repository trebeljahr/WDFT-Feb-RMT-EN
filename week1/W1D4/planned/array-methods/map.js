...
e 
// we need a function to capitalize thee 
// we need a function to capitalize thfirst letter of a name
function toCapitalized(name) {
  return name[0].t
// we need a function to capitalize the first letter of a name
function toCapitalized(name) {
  return name[0].t first letter of a name
function toCapitalized(name) {
  return name[0].t
// we need a function to capitalize the first letter of a name
function toCapitalized(name) {
...
// we need a function to capitalize the first letter of a name
function toCapitalized(name) {
  return name[0].teturn name[0].toUpperCase() + name.slice(1);
}
